...
\noindent {\Huge{\textbf{   Михаил Акушский   }}}%
\ifdetailed
...
\ifdetailed
\noindent {\textbf{ЦЕЛЬ}}: Работа в крупной стабильной IT-компании в роли ведущего разработчика ПО, системного архитектора, лидера команды.
\else
\noindent {\textbf{Цель}}: Ведущий разработчик ПО, системный архитектор, лидер команды
\fi
...
\ifproduct
\else
\item 22 года опыта в области IT, разработки ПО, с использованием широкого круга технологий (PHP, Perl, Delphi,C++, MySQL, HTML, Javascript, ...)
\item 12 лет опыта управления в качестве лидера проекта, менеджера проекта, менеджера продукта.
\item 4 года опыта в области розничных продаж, е-commerce;
\item Глубокие знания и опыт в области e-commerce, разработки ПО, полиграфии, дизайна.
\item Глубокие знания в области интеграции систем, миграции данных, отчетности, анализа данных, проектированиясистем, разработки ПО.
\item Аналитическое мышление, умение находить решения нерешаемых проблем, широкий кругозор, быстрообучае-мый.
\item Языки --- русский (родной), английский (второй язык, upper intermediate) и французский (базовый).

\fi
\end{itemize}
\else
\noindent {\textbf{Профиль}}: 9 лет опыта разработки ПО (ведущий программист, лидер команды ); Web, e-commerce {\em{(e.g.: Enter, Svyaznoy, Chronopay, NaDiske.ru);}}  focusing for Web/Internet during last 13 years,  Windows/Linux development, iOS/Android projects {\em (e.g. my own game \href{http://wordrive.com}{Wordrive})}, ERP/1C projects {\em (in Mail.Ru Group and ENTER)}, speaker (\href{http://2013.russianinternetforum.ru/p/details.php?ID=1129}{RIF}, \href{http://2012.russianinternetweek.ru/program/internet-management/}{RIW}, Codefest,{}…), IT consultant (RIK); quite good in technologies and methods:  Perl, PHP, Bash, SQL, Dephi, LaTeX, 1C, VBA, Office, PMI PMBOK, ITIL, AGILE. Education: Computer and networks, master degree, \href{http://www.rsreu.ru/index.php?lang=en}{Radio-Engineering University of Ryazan,}, \href{http://www.itexpert.ru/}{IT EXPERT}/\href{http://pmexpert.ru/}{PM EXPERT}.
\fi
\vspace{1em}
